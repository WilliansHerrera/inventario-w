...
/**
 * @extends IndexPage<VentaResource>
 */
class VentaIndexPage extends IndexPage
{
    ...
    protected function fields(): iterable
    {
        return [
            ...
            BelongsTo::make(__('Caja'), 'caja', resource: CajaResource::class)->sortable(),
            Number::make(__('Total'), 'total')
                ->sortable()
                ->columnSelection(false)
                ->changePreview(fn ($value) => format_currency((float) $value)),
            Text::make(__('Método de Pago'), 'metodo_pago')->sortable(),
        ];
    }
